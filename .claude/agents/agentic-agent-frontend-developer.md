---
name: agentic:agent:frontend-developer
description: Frontend Developer. Implements UI following design decisions and technical plan.
tools: Read, Write, Edit, Glob, Grep, Bash
model: opus
skills: [agentic:skill:frontend-design, agentic:skill:ux-patterns, agentic:skill:refactoring-ui, agentic:skill:code, agentic:skill:clean-architecture, agentic:skill:observability, agentic:skill:dx, agentic:skill:context7]
color: cyan
---
