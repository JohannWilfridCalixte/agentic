...
The Discovery subagent will read its own instructions from `.claude/skills/product-discovery/SKILL.md`.

### Delegate

```
Task(subagent_type="general-purpose", prompt="
You are the Discovery agent. Read .claude/skills/product-discovery/SKILL.md for your full instructions.
