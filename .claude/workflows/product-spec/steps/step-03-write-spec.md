...
The Designer subagent will use `.claude/skills/brainstorming/SKILL.md` for design exploration.

### Step 3.1: Design Exploration (Delegate)

```
Task(subagent_type="general-purpose", prompt="
You are the Designer agent. Read .claude/skills/brainstorming/SKILL.md for your full instructions.
