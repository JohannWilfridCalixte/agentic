...
You are the QA agent. Read .claude/agents/qa.md for your full instructions.
...
```
Task(subagent_type="general-purpose", prompt="
You are the Security QA agent. Read .claude/agents/security-qa.md for your full instructions.
...
```
Task(subagent_type="general-purpose", prompt="
You are the Editor agent. Read .claude/agents/editor.md for your full instructions (Fix Phase section).
