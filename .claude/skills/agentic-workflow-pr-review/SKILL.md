...
```
Task(subagent_type="general-purpose", prompt="You are the Architect agent. Read .claude/agents/agentic-agent-architect.md for your full instructions. ...")
Task(subagent_type="general-purpose", prompt="You are the QA agent. Read .claude/agents/agentic-agent-qa.md for your full instructions. ...")
Task(subagent_type="general-purpose", prompt="You are the Test QA agent. Read .claude/agents/agentic-agent-test-qa.md for your full instructions. ...")
Task(subagent_type="general-purpose", prompt="You are the Security QA agent. Read .claude/agents/agentic-agent-security-qa.md for your full instructions. ...")
```
...
All outputs: `.claude/_agentic_output/task/pr-review/{pr-identifier}/{instance_id}/`
...
1. Read and execute Read {path_to_this_workflow}/steps/step-03-gather-context.md
2. Read and execute Read {path_to_this_workflow}/steps/step-04-dispatch-reviews.md
3. Read and execute Read {path_to_this_workflow}/steps/step-05-output.md
...
```
.claude/_agentic_output/task/pr-review/pr-{N}/{instance_id}/
```
