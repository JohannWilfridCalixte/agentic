---
name: agentic:workflow:frontend-development
...
# /agentic:workflow:frontend-development - Frontend Development Workflow

**Usage:** `/agentic:workflow:frontend-development [<input>]`
...
Available agents: `agentic:agent:ui-ux-designer`, `agentic:agent:frontend-developer`, `agentic:agent:qa`
...
All outputs: `.claude/_agentic_output/frontend/{session_id}/`
