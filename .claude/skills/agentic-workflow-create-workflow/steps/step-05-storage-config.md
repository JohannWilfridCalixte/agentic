...
Options:
  - "Agentic output directory (Recommended)" — Uses .claude/_agentic_output/{category}/{topic}/{instance_id}/ pattern. Files stored locally alongside the project.
...
storage_path_template: ".claude/_agentic_output/{category}/{topic}/{instance_id}/"
```
