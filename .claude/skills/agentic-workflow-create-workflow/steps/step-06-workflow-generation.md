...
name: agentic:workflow:{created_workflow.name}
...
Invoke: `Task(subagent_type="general-purpose", prompt="...")`
...
Read .claude/agents/agentic-agent-{agent-name}.md
...
- Step 1 of the generated workflow uses:
  ```yaml
  output_path: ".claude/_agentic_output/{storage_category}/{topic}/{instance_id}"
  ```
