---
name: agentic:workflow:product-vision
...
Invoke: `Task(subagent_type="general-purpose", prompt="You are the CPO agent. Read .claude/agents/agentic-agent-cpo.md for your full instructions and mandatory setup. ...")`
...
All outputs: `.claude/_agentic_output/product/vision/{topic}/{instance_id}/`
