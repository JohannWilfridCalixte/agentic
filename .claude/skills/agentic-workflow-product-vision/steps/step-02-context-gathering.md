...
Before creative exploration, explore the existing codebase and project docs to understand what exists. This prevents brainstorming from starting with zero knowledge and surfaces integration concerns, edge cases, and constraints early.
...
You are gathering product and technical context for a product vision session about: {topic}

Raw idea: {raw_input}

Your goal: understand the existing system so that product vision brainstorming can account for integration, edge cases, and constraints.
...
**If validation fails:**
- Ask user to fill gaps ("What existing features relate to {topic}?")
...
Load `step-03-creative-exploration.md`
