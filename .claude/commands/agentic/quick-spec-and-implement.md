...
Invoke: `Task(subagent_type="general-purpose", prompt="You are the {Agent} agent. Read .claude/agents/{agent}.md for your full instructions. ...")`
...
Load: `Read .claude/agents/architect.md`
...
Load: `Read .claude/agents/security.md`
...
Load: `Read .claude/agents/editor.md`
...
**7b. Security Review**
Load: `Read .claude/agents/security-qa.md`
