...
Each subagent uses its skill from `.claude/skills/{skill}/SKILL.md`.

Invoke: `Task(subagent_type="general-purpose", prompt="You are doing product discovery. Read .claude/skills/product-discovery/SKILL.md for your instructions. ...")`
...
Load: `Read .claude/skills/product-discovery/SKILL.md`
...
Load: `Read .claude/skills/brainstorming/SKILL.md`
