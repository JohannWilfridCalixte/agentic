...
model: {qaModelName}
skills: [agentic:skill:code, agentic:skill:code-testing, agentic:skill:qa, agentic:skill:typescript-engineer]
color: green
---
...
Confirm: "Skills loaded: agentic:skill:code, agentic:skill:code-testing, agentic:skill:qa, agentic:skill:typescript-engineer"
