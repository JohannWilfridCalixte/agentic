...
skills: [agentic:skill:tech-vision, agentic:skill:brainstorming, agentic:skill:context7]
color: orange
---
...
```
Skill(skill="agentic:skill:tech-vision")
...
Confirm: "Skills loaded: agentic:skill:tech-vision, agentic:skill:brainstorming, agentic:skill:context7"
