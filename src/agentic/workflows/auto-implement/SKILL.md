...
```
Task(subagent_type="{subagentTypeGeneralPurpose}", prompt="You are the Architect agent. {ide-invoke-prefix}{ide-folder}/agents/agentic-agent-architect.md for your full instructions. Execute Phase 1: Context Gathering. ...")
Task(subagent_type="{subagentTypeGeneralPurpose}", prompt="You are the Architect agent. {ide-invoke-prefix}{ide-folder}/agents/agentic-agent-architect.md for your full instructions. Execute Phase 2: Technical Planning. ...")
...
Available agents: `agentic:agent:architect`, `agentic:agent:editor`, `agentic:agent:test-engineer`, `agentic:agent:qa`, `agentic:agent:test-qa`, `agentic:agent:security-qa`
