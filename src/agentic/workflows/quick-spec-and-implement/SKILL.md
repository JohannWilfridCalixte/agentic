...
```
Task(subagent_type="{subagentTypeGeneralPurpose}", prompt="You are the {Agent} agent. {ide-invoke-prefix}{ide-folder}/agents/agentic-agent-{agent}.md for your full instructions. {task-specific context}")
```

Available agents: `agentic:agent:pm`, `agentic:agent:architect`, `agentic:agent:security`, `agentic:agent:editor`, `agentic:agent:test-engineer`, `agentic:agent:qa`, `agentic:agent:test-qa`, `agentic:agent:security-qa`
