...
```
/agentic:workflow:auto-implement path/to/file.md    → read file
/agentic:workflow:auto-implement #123               → gh issue view 123
/agentic:workflow:auto-implement https://github...  → gh issue view <url>
/agentic:workflow:auto-implement <text>             → use as-is
/agentic:workflow:auto-implement                    → ERROR: input required
```
