...
The Test Engineer subagent will read its own instructions from `{ide-folder}/agents/agentic-agent-test-engineer.md`.
...
{ide-invoke-prefix}{ide-folder}/agents/agentic-agent-test-engineer.md
