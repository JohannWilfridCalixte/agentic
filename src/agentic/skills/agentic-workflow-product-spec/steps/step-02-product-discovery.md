...
The Discovery subagent will read its own instructions from `{ide-folder}/skills/agentic-skill-product-discovery/SKILL.md`.

### Delegate

```
Task(subagent_type="{subagentTypeGeneralPurpose}", prompt="
You are the Discovery agent. {ide-invoke-prefix}{ide-folder}/skills/agentic-skill-product-discovery/SKILL.md for your full instructions.
