...
> - `/agentic:technical-planning` — interactive technical planning workflow
> - Cursor planning mode or Claude Code planning mode
>
> Then re-invoke `/agentic:implement` with the resulting plan.
...
### No Technical Plan
1. HALT immediately
2. Direct developer to `/agentic:technical-planning` or planning mode
3. Do NOT proceed
...
```
                    /agentic:implement <technical-plan>
                                |
                                v
                +-------------------------------+
